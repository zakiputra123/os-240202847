...
### **Tugas yang Harus Dilakukan**
 ...
 2. 2. **Implementasikan `getReadCount()`**: Buat *system call* `int getReadCount(void)` yang mengembalikan total berapa kali *system call* `read()` telah dieksekusi sejak sistem boot.
